...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--mask_need_scale", action="store_true", help="enabling this param means that the pixel range of the mask is 0-255")
        self.parser.add_argument("--scale_num", type=int, default=1)

        self.parser.add_argument("--save_feature_url", type=str, default="", help="While extracting the features, where to put")
